...
public final class Const {
	...
	public final static String superObjectTag = ".super L";
	public final static String applicationAttachLineTag = ".method protected attachBaseContext(Landroid/content/Context;)V";
	public final static String applicationFinalAttachLineTag = ".method protected final attachBaseContext(Landroid/content/Context;)V";
	public final static String applicationCreateLineTag = ".method public onCreate()V";
	public final static String applicatiFinalonCreateLineTag = ".method public final onCreate()V";
